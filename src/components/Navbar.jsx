...
// const Navbar = [
//   { name: 'About us', href: '#whatWeDo', current: false },
 
//   { name: 'Our privacy Policy', href: '#services', current: false },
//   { name: '', href: '#services', current: false },
// ]
...
//   } 
//   return (
//     <Disclosure as="nav" className="bg-color2">
//       {({ open }) => (
//         <>
...
//                           item.current ? ' text-black' : 'text-black-300 hover:bg-blue-700 hover:text-white',
...
//              <button onClick={goToLoginPage} class="border  border-black rounded-full font-bold px-8 py-2 hover:bg-blue-800">Login/Signup</button>
//             </div>
//           </div>
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                <button className="btn btn-warning" onClick={goToLoginPage}>Login/Signup</button>
              </div>
            </div>
          </div>
        </nav>
