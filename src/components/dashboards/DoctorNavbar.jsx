...
export default function DoctorNavbar() {
  ...
  const getLoggedInUserData = async () => {
    try {
      const response = await getLoggedInUser(authContext.emailAddress, authContext.token);
...
//   const goToPatientMedicalFormPage=async ()=>{
//     await getLoggedInUserData()
//     navigate(`/patientMedicalData/${id}`)
// }
const goToPatientMedicalFormPage = async () => {
  try {
    await getLoggedInUserData();
    navigate(`/patientMedicalData/${ids}`);
  } catch (error) {
    console.error(error);
  }
};
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                {/* <div className="ml-4 flow-root lg:ml-6">
                 ...
                 <button onClick={goToPatientMedicalFormPage} type='button' className="btn btn-primary">Add Patient</button>
              </div>
            </div>
          </div>
        </nav>
